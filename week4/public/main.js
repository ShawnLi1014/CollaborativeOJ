...
module.exports = "@media screen {\n  #editor {\n    height: 600px;\n  }\n\n  header.btn {\n    margin: 0 5px;\n  }\n\n  footer.btn {\n    margin: 0 5px;\n  }\n\n  .editor-footer, .editor-header {\n    margin: 10px 0;\n  }\n\n  .cursor {\n    background: rgba(0, 250, 0, 0.5);\n    z-index: 40;\n    width: 2px!important;\n  }\n\n  .card {\n    margin-top: 20px;\n  }\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var EditorComponent = /** @class */ (function () {
    ...
    EditorComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (queryParams) {
            ...
            if (queryParams['sessionId']) {
                _this.sessionId = queryParams['sessionId'];
                _this.initEditor();
            }
        });
    };
    ...
    EditorComponent.prototype.submit = function () {
        ...
        console.log(data);
        this.data.buildAndRun(data).then(function (res) {
            _this.output.build = res.build;
            _this.output.execute = res.run;
    ...
    EditorComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, Object, _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], EditorComponent);
...
module.exports = ".masthead {\n  height: 100vh;\n  min-height: 500px;\n  background-image: url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80');\n  background-size: cover;\n  background-position: center;\n  background-repeat: no-repeat;\n  color: #fbfdfa;\n}\n\n\n\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<header class=\"masthead\">\n  <div class=\"container h-100\">\n    <div class=\"row h-100 align-items-center\">\n      <div class=\"col-12 text-center\">\n        <h1 class=\"font-weight-light\">LET'S CODE</h1>\n        <p class=\"lead\">Solving coding problems, Collaboratively</p>\n        <button type=\"button\" class=\"btn btn-primary btn-lg\" routerLink='/problems'>Get Started</button>\n      </div>\n    </div>\n  </div>\n</header>\n\n<!-- Page Content -->\n<section class=\"py-5\">\n  <div class=\"container\">\n    <h2 class=\"font-weight-light\">What is Let's Code?</h2>\n    <p>Lets Code is a prototype of a coding platform, which allows people working on one problem simultaneously.</p>\n  </div>\n</section>\n"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.auth.userNameChange$.subscribe(function (username) {
...
module.exports = "<!--<div *ngIf=\"auth.isAuthenticated() && auth.userHasScopes(['write:messages'])\">-->\n<div *ngIf=\"authGuard.isAdmin()\">\n  <form #formRef=\"ngForm\">\n    <div class=\"form-group\">\n      <label for=\"problemName\">Problem Name</label>\n      <input type=\"text\" class=\"form-control\" id=\"problemName\" name=\"problemName\" placeholder=\"Enter Problem Name\" [(ngModel)]=\"newProblem.name\" required>\n      <div class=\"valid-feedback\">\n        Looks good!\n      </div>\n      <div class=\"invalid-feedback\">\n        Please provide a problem name.\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"problemDesc\">Problem Description</label>\n      <textarea type=\"text\" rows=\"3\" class=\"form-control\" id=\"problemDesc\" name=\"problemDesc\" placeholder=\"Enter Problem Description\" [(ngModel)]=\"newProblem.desc\" required></textarea>\n      <div class=\"valid-feedback\">\n        Looks good!\n      </div>\n      <div class=\"invalid-feedback\">\n        Please provide problem description.\n      </div>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"difficulty\">Problem Difficulty</label>\n      <select type=\"text\" class=\"form-control\" id=\"difficulty\" name=\"difficulty\" [(ngModel)]=\"newProblem.difficulty\"  required>\n        <option value=\"default\" disabled selected>Select Difficulty</option>\n        <option *ngFor=\"let difficulty of difficulties\" [value]=\"difficulty\">\n          {{difficulty}}\n        </option>\n      </select>\n      <div class=\"valid-feedback\">\n        Looks good!\n      </div>\n      <div class=\"invalid-feedback\">\n        Please select problem difficulty.\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col-md-12\">\n        <button type=\"submit\" class=\"btn btn-primary pull-right\" (click)=\"addProblem()\">Add Problem</button>\n      </div>\n    </div>\n  </form>\n</div>\n\n\n"
...
module.exports = ".container {\n  margin-top: 20px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".difficulty {\n  min-width: 65px;\n  margin-right: 10px;\n}\n\n.badge.difficulty {\n  color: #fbfdfa;\n  font-size: 12px;\n}\n\n.title {\n  font-size: 1.2em;\n}\n\n.diff-easy {\n  background-color: #42ebf4;\n}\n\n.diff-medium {\n  background-color: #92cf5c;\n}\n\n.diff-hard {\n  background-color: #dd0d1e;\n}\n\n.diff-super {\n  background-color: #8d16e2;\n}\n\n.problem-list {\n  margin-top: 20px;\n}\n\n#toast-container > div {\n  opacity:1;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"container\">\n  <app-new-problem></app-new-problem>\n  <div class=\"problem-list\">\n\n    <table class=\"table\">\n      <thead class=\"thead-dark\">\n      <tr>\n        <th scope=\"col\">No.</th>\n        <th scope=\"col\">Title</th>\n        <th scope=\"col\">Difficulty</th>\n      </tr>\n      </thead>\n      <tbody>\n      <tr *ngFor=\"let problem of problems | search: searchTerm\" [routerLink]=\"['/problems', problem.id]\" [queryParams]=\"{sessionId: sessionId}\">\n        <th scope=\"row\">{{problem.id}}</th>\n        <td>{{problem.name}}</td>\n        <td><span class=\"{{'badge badge-pill difficulty diff-' + problem.difficulty.toLocaleLowerCase()}}\">{{problem.difficulty | uppercase}}</span></td>\n      </tr>\n      </tbody>\n    </table>\n  </div>\n</div>\n"
...
var ProblemListComponent = /** @class */ (function () {
    ...
    ProblemListComponent.prototype.ngOnInit = function () {
        console.log(shortid__WEBPACK_IMPORTED_MODULE_2__["generate"]());
        this.sessionId = shortid__WEBPACK_IMPORTED_MODULE_2__["generate"]();
        this.getProblems();
        this.getSearchTerm();
    };
...
module.exports = __webpack_require__(/*! /Users/litianlun/Projects/CollaborativeOJ/week4/oj-client/src/main.ts */"./src/main.ts");
